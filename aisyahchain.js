...
aisyahChain.addBlock(new Block(Date.now().toString(), ["Hello BUIDLERS1"]));
aisyahChain.addBlock(new Block(Date.now().toString(), ["Hello BUIDLERS2"]));
aisyahChain.addBlock(new Block(Date.now().toString(), ["Hello BUIDLERS3"]));
